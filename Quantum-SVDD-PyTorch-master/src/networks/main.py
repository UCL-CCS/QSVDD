...
from .fashionmnist_LeNet import FashionMNIST_LeNet, FashionMNIST_LeNet_Autoencoder

def build_network(net_name):
    """Builds the neural network."""

    implemented_networks = ('mnist_LeNet', 'cifar10_LeNet', 'cifar10_LeNet_ELU','fashionmnist_LeNet')
    ...
    if net_name == 'fashionmnist_LeNet':
